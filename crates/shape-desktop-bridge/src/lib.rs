//! Bounded, read-only desktop projection over a real Shape project.
//!
//! Rust owns project validation, `SQLite`, object verification, and domain
//! interpretation. C++ receives explicit presence flags and presentation-safe
//! values through one generated CXX contract; QML never reads project files.
