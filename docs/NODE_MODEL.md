...
| 输出端点 | 对应步骤的结果 | 可供其他节点引用的已采用版本 | 在产出步骤上显示结果；候选必须显式采用后才能成为下游输入 |
...
关系图把每个 Output Artifact 显示在产出步骤的输出端点，不为文本或音频结果另画整张卡；
点端点可检查该结果和已采用版本。手写或导入的原稿显示为一张素材卡，
AI 创作显示创作步骤与其输出端点。沿唯一已有连线点击端口的 `+`
