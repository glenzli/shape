...
创作与编辑共用一个文本工作区；正式格式只区分普通文本与配音脚本，听力、对话作为可选写作示例，AI 作为执行方式。
...
“新建内容”第一层区分自由文字与配音脚本，后者提供通用脚本入口，以及听力练习、多人对话写作示例；示例不成为独立格式。
第二层选择让 AI 起稿、整理现有文本或手写；不要求先提交正文。规则在写稿前可查阅，AI 请求
自动携带统一规范；角色、提示音、停顿、语气及重复由脚本指令表达，写作示例不增加独立制作约束。第三层检查完整阅读预览或脚本源码，
